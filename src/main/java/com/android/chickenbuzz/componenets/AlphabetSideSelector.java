...
public class AlphabetSideSelector extends View {
    private static String TAG = AlphabetSideSelector.class.getCanonicalName();
    ...
    public AlphabetSideSelector(Context context) {
        super(context);
        init();
    }

    public AlphabetSideSelector(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public AlphabetSideSelector(Context context, AttributeSet attrs, int defStyle) {
