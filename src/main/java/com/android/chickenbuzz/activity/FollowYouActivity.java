...
public class FollowYouActivity extends BaseActivity  {

    private FollowYouActivity mActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.title_follow_you));
        ...
        if (findViewById(R.id.fragment_container) != null) {
            ...
            FollowYouFragment firstFragment = new FollowYouFragment();
