...
public class ChangePinActivity extends BaseActivity implements View.OnClickListener,SmoothCheckBox.OnCheckedChangeListener{

    private EditText inputpin,inputconfirmPin,inputemergencyPin,inputconfirmEmergencyPin;
    private TextInputLayout inputLayoutPin, inputLayoutPhoneNumber,inputLayoutConfirmPin,inputLayoutEmergencyPin,inputLayoutConfirmEmergencyPin;
...
//    private SmoothCheckBox checkBox;
    ...
    private String /*inter_phoneNumber,*/registerpin,emergencyPin, /*invitationnCode,isd_code,*/ verification_code;
...
//        checkBox.setOnCheckedChangeListener(this);
    ...
    private void submitRegister() {
        ...
        if (NetworkUtils.checkInternetConnectivity(this)) {
            if (/*isd_code != null && inter_phoneNumber != null && */ verification_code != null
                ...
                NetworkUtils.showAlertDialog(ChangePinActivity.this, getString(R.string.err_msg_mandatory_fields_not_filled));
            }
        } else {
    ...
    private void startMainActivity(){
        finish();
        Intent intent = new Intent(ChangePinActivity.this, InteractionActivity.class);
...
//        }
    ...
    private class RegistrationTextWatcher implements TextWatcher {
     ...
     private boolean validateRegisterPin() {
        ...
        else if(!inputpin.getText().toString().equalsIgnoreCase(verification_code)){
            inputLayoutPin.setError(getString(R.string.err_msg_smsverfication_pin));
            requestFocus(inputpin);
            return false;
        }
        else {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, registerUrl,
                        ...
                        try {
                            ...
                            if(responseobject != null) {
                                if (responseobject.has("reponse_code") &&
                                    ...
                                    NetworkUtils.showAlertDialog(ChangePinActivity.this,
                                    ...
                                    if(message.has("message")) {
                                        if (message.getString("message").equalsIgnoreCase("Success")) {
                                            Utility.saveStringPreference(ChangePinActivity.this, Constant.KEY_USER_ID,
                                                    (message.has("user_id") ? message.getString("user_id") : ""));
                                            startMainActivity();
                                        }
                                        else{
                                            NetworkUtils.showAlertDialog(ChangePinActivity.this, message.getString("message"));
                                        }
                                    }
                                    else{
                                        NetworkUtils.showAlertDialog(ChangePinActivity.this,getString(R.string.error_unable_to_get_response));
                                    }
                                }
                                else{
                                    NetworkUtils.showAlertDialog(ChangePinActivity.this, getString(R.string.error_unable_to_get_response));
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        NetworkUtils.showAlertDialog(ChangePinActivity.this,error.getMessage());
                        hideProgressDialog();
                    }
                }) {
